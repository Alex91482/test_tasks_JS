...
public class MyConstants {
    ...
    public static final String MY_EMAIL = "clinic.automessanger@gmail.com";
    public static final String MY_PASSWORD = "autoMessenger$_01";
    ...
    public static final String SANDARD_TELLMELOG = ".\n In your personal account, you can find out personal recommendations for treatment.\n Your login: ";
    public static final String SANDARD_TELLMEPASS = "\n Your password: ";
}
