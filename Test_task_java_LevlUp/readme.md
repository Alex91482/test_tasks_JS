...
### 1. Stage one
	:white_check_mark: Постановка задачи.
...
#### Questions and comments 
	:black_square_button: Как пациент увидит какое время доступно для записи у конкретного врача?
	...
	:white_check_mark: Добавление таблицы в которую будет записыватся диагноз и рекомендации по лечению
```sql
	CREATE TABLE disease_history
	(
	Id PRIMARY KEY,
