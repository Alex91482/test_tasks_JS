...
### 2. Creating a repository with reserved data
	...
	PatientServiceController обладает методами
		patientList() - получения списка всех зарезервированных дат с указанием специализации врача
	...
	будет передоватся в "doctorSpetialisation" присутствует значение по умолчанию "Терапевт"
