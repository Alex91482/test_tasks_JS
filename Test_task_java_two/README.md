...
7. List<CoffeeMachineA> Информация
...
и сохраняем как событие "Id, Приготовление Американо, Текущее время/дата, кол-во оставшийся воды,
кол-во оставшегося кофе".
5-6 пункт должны иммитировать полное заполнение бака с водой и кофе.
7 пункт служит для отображения статистики использования кофемашины.
